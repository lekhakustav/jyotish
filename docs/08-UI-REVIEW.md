...
| Home | Removed greeting/name/diya header and empty family/event placeholders. Kept tithi, rashifal, settings, Open Patro, and floating Pandit action. | Removed AD date and year from the hero; tithi, paksha, and nakshatra are separate scan lines. | Flat vertical rhythm remains; contextual actions replace hidden tabs. |
