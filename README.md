...
- [docs/21-SOCIAL-CAROUSEL-WORKFLOW.md](docs/21-SOCIAL-CAROUSEL-WORKFLOW.md) — complete Instagram and TikTok carousel workflow, archives, proof, and verification
