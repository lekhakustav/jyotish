...
end_card="$repo_root/marketing/media/launch-001/prototypes/cou001/med_20260718_cou001v3__store-endcard.png"
output_video="${1:-$repo_root/marketing/media/launch-001/prototypes/cou001/med_20260718_cou001v3__cmp_20260716_launch__narration-forward__store-endcard.mp4}"
...
ffmpeg -hide_banner -loglevel error -y \
  ...
  -filter_complex "
    ...
    [0:a]atrim=duration=8,asetpts=PTS-STARTPTS,
      volume='if(between(t,0.35,5.95),0.10,0.28)',
